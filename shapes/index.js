...
var circuit_digital_gate_DIN40700_AND = CircuitFigure.extend({
   ...
   init:function(attr, setter, getter)
   {
     ...
     var port;
     // Port
     port = this.addPort(new DecoratedOutputPort(), new draw2d.layout.locator.XYRelPortLocator({x: 91.56704536254959, y: 50 }));
     port.setConnectionDirection(1);
     port.setBackgroundColor("#37B1DE");
     port.setName("Port");
     port.setMaxFanOut(20);
...
var circuit_digital_gate_OR = CircuitFigure.extend({
   ...
   init:function(attr, setter, getter)
   {
     ...
     port.setMaxFanOut(20);
     // output
     port = this.addPort(new DecoratedOutputPort(), new draw2d.layout.locator.XYRelPortLocator({x: 116.83569979716025, y: 50 }));
     port.setConnectionDirection(1);
     port.setBackgroundColor("#37B1DE");
     port.setName("output");
     port.setMaxFanOut(20);
