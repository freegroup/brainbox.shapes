...
var video_detector_Hough = CircuitFigure.extend({
   ...
   createSet: function()
   {
       ...
       // Label
       shape = this.canvas.paper.text(0,0,'Hough');
       shape.attr({"x":16.228799999999865,"y":68.54423942400535,"text-anchor":"start","text":"Hough","font-family":"\"Arial\"","font-size":16,"stroke":"#000000","fill":"#080808","stroke-scale":true,"font-weight":"normal","stroke-width":0,"opacity":1});
       shape.data("name","Label");
...
var video_detector_RobertsInvers = CircuitFigure.extend({
   ...
   init:function(attr, setter, getter)
   {
     ...
     this._super( $.extend({stroke:0, bgColor:null, width:3614.9464044800116,height:3579.3292616320105},attr), setter, getter);
     var port;
     // input_port1
     port = this.addPort(new DecoratedInputPort(), new draw2d.layout.locator.XYRelPortLocator({x: 2.074719556202889, y: 2.095364648453812 }));
     port.setConnectionDirection(3);
     port.setBackgroundColor("#37B1DE");
     port.setName("input_port1");
     port.setMaxFanOut(20);
     // output_port1
     port = this.addPort(new DecoratedOutputPort(), new draw2d.layout.locator.XYRelPortLocator({x: 2.074719556202889, y: 2.095364648453812 }));
     port.setConnectionDirection(1);
     port.setBackgroundColor("#37B1DE");
     port.setName("output_port1");
     port.setMaxFanOut(20);
   ...
   {
      var shape = this._super();
      this.originalWidth = 3614.9464044800116;
      this.originalHeight= 3579.3292616320105;
      return shape;
   },
   ...
   createSet: function()
   {
       ...
       var shape = null;
       // BoundingBox
       shape = this.canvas.paper.path("M0,0 L3614.9464044800116,0 L3614.9464044800116,3579.3292616320105 L0,3579.3292616320105");
       shape.attr({"stroke":"none","stroke-width":0,"fill":"none"});
       shape.data("name","BoundingBox");
       ...
       // Label
       shape = this.canvas.paper.text(0,0,'Roberts');
       shape.attr({"x":19.96875,"y":66.625,"text-anchor":"start","text":"Roberts","font-family":"\"Arial\"","font-size":16,"stroke":"#000000","fill":"#080808","stroke-scale":true,"font-weight":"normal","stroke-width":0,"opacity":1});
       shape.data("name","Label");
       ...
       // Line
       shape = this.canvas.paper.path('M3609.9464044800116 3574.3292616320105L3610.1141766400106,3625.3346197120045');
       shape.attr({"stroke-linecap":"round","stroke-linejoin":"round","stroke":"rgba(0,0,0,1)","stroke-width":2,"stroke-dasharray":null,"opacity":1});
       shape.data("name","Line");
