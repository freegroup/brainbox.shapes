...
var signal_SignalSwitch = CircuitFigure.extend({
   ...
   createSet: function()
   {
       ...
       // Label
       shape = this.canvas.paper.text(0,0,'5-X');
       shape.attr({"x":6.8828125,"y":18.00489618530264,"text-anchor":"start","text":"5-X","font-family":"\"Arial\"","font-size":16,"stroke":"#000000","fill":"#080808","stroke-scale":true,"font-weight":"normal","stroke-width":0,"opacity":1});
       shape.data("name","Label");
