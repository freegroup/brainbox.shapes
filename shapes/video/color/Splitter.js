    ...
    onStart:function( context )
    {
        ...
        var workerFunction = function(event){
            ...
            for( let x = 0; x < pixels.length; x += 4 ) {
                r[x]=r[x+1]=r[x+2] = threshold < (pixels[x]  -(pixels[x+1]+pixels[x+2]))?255:0;
                g[x]=g[x+1]=g[x+2] = threshold < (pixels[x+1]-(pixels[x]  +pixels[x+2]))?255:0;
                b[x]=b[x+1]=b[x+2] = threshold < (pixels[x+2]-(pixels[x+1]+pixels[x]))?255:0;
            }
