...
var video_ToBlackWhite = CircuitFigure.extend({
   ...
   init:function(attr, setter, getter)
   {
     ...
     var port;
     // input_port1
     port = this.addPort(new DecoratedInputPort(), new draw2d.layout.locator.XYRelPortLocator({x: -1.875, y: 48.77299116943961 }));
     ...
     port.setMaxFanOut(20);
     // output_port1
     port = this.addPort(new DecoratedOutputPort(), new draw2d.layout.locator.XYRelPortLocator({x: 101.86500000000024, y: 48.787627457676564 }));
